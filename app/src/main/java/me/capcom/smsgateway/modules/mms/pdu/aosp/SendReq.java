...
// Utils.getMyPhoneNumberFromSubscription is supplied by the caller via
// prepareFromAddress(fromAddress) — the device MSISDN lookup used to live
// in klinker-apps' Utils class but we rely on the outer Kotlin sender to
// resolve it from SubscriptionsHelper.
